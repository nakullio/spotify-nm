import { HeartIcon, VolumeUpIcon as VolumeDownIcon, SwitchHorizontalIcon } from "@heroicons/react/outline";
...
function Player() {
    ...
    // debounce concept using useCallBack = will memoaize function, which means on every input, 
    // it will wait 500ms then they will run the function
    ...
    return (
        <div className="h-24 bg-gradient-to-b from-black to-gray-900 text-white grid grid-cols-3 text-xs md:tex-base px-2 md:px-8">
            {/* left side */}
